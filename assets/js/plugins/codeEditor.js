(function($) {
  ...
  if ($('textarea[name=code-readonly]').length) {
  ...
  if ($('textarea[name=code-display]').length) {
    var readOnlyCodeMirror = CodeMirror.fromTextArea(document.getElementById('code-display'), {
      mode: "javascript",
      theme: "ambiance",
      lineNumbers: false,
      readOnly: "nocursor"
